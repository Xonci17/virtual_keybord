    ...
    if lmList:
        for button in buttonList:
            ...
            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h:
                ...
                cv2.putText(img, button.text, (x + 22, y + 63), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
                thumb_tip = lmList[4]  # Get thumb tip (landmark index 4)
                fingertip = lmList[8]  # Get fingertip (landmark index 8)
                x1, y1 = thumb_tip[1], thumb_tip[2]  # Extract x and y from thumb tip
                x2, y2 = fingertip[1], fingertip[2]  # Extract x and y from fingertip
